...
\title{{\Huge Doclang}\\A documentation and typesetting
...
\inputtex{chap-purpose.tex}
\inputtex{chap-document-structure.tex}
\inputtex{chap-mathematic-notation.tex}
\inputtex{chap-bibliography-entry.tex}

\bibliography{doclang-requirements}{}
